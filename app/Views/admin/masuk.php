  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-xl-10 col-lg-12 col-md-9">
        <div class="card-auth o-hidden border-0 shadow-lg my-7">
            ...
            <div class="row">
              ...
              <div class="col-lg-7">
                ...
                <div class="p-5">
                  ...
                  <form class="user" action="<?= site_url('/admin/masuk'); ?>" method="post" autocomplete="off">
                    <?= csrf_field(); ?>
                  ...
                  <hr class="mt-2 mb-1">
                  <div class="text-center">
                    <a class="small" href="<?= site_url('/masuk'); ?>">Kembali ke halaman pelajar</a>
                  </div>
                </div>
              </div>
            </div>
