...
<script>
  // localStorage.clear();
  <?php
  // session()->set("timer_status", "stopped")
  ?>
  ...
  function btnTimer() {
    if (sec > 0) {
      ...
      window.clearInterval(interval);
      sec = 0;
      <?php session()->set("timer_status", "stopped") ?>
      localStorage.clear();
      $("#btn_resend").prop('disabled', false);
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        <div class="card-auth o-hidden border-0 shadow-lg mt-9 mb-9">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-5 d-none d-lg-block bg-activation-image">
              ...
              <div class="col-lg-7">
                ...
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h3 text-gray-900 mb-2 font-weight-bold">Aktivasi Akun</h1>
                  </div>
                  ...
                  <form id="form_resend" class="user" action="<?= site_url('/aktivasi/kirim_ulang'); ?>" method="post" autocomplete="off">
                    <?= csrf_field(); ?>
