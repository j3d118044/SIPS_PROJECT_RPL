...
<nav class="navbar fixed-top navbar-expand-lg text-primary">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-link active" href="pages/home">Beranda</a>
                <a class="nav-link" href="pages/materi">Materi</a>
                <a class="nav-link" href="pages/latihansk">Latihan Studi Kasus</a>
                <a class="nav-link" href="pages/quiz">Quiz</a>
                <a class="nav-link" href="pages/peringkat">Peringkat</a>
                <a class="nav-link" href="pages/masuk">Masuk</a>
            </div>
        </div>
    </div>
</nav> -->